...
ProblemLoader::ProblemLoader(const string &file_path,
...
ProblemData ProblemLoader::LoadProblem() {
  ...
  ParseLcVrpFile(file_path_, problem_data);
...
void ProblemLoader::ParseLcVrpFile(const string &file_path,
                                   ProblemData &problem_data) {
...
void ProblemLoader::ParseEdgeWeightSection(ifstream &file,
                                           ProblemData &problem_data) {
  int dimension = problem_data.GetDimension();
  vector<vector<double>> edge_weights(dimension,
...
void ProblemLoader::ParseNodeCoordSection(ifstream &file,
                                          ProblemData &problem_data) {
  int dimension = problem_data.GetDimension();
...
void ProblemLoader::ParseDemandSection(ifstream &file,
                                       ProblemData &problem_data) {
  int dimension = problem_data.GetDimension();
...
void ProblemLoader::ParseDepotSection(ifstream &file,
                                      ProblemData &problem_data) {
  int depot;
  file >> depot;
